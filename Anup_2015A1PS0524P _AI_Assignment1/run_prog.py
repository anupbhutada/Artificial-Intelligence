...
for i in range(10,100,5):
    dirt_a = genDirt((10,10),i)
    t0 = time.clock()
    root = node(init_pos, (10,10), dirt_a)
    perm = 200000
    while(True):
        root.children = []
        queue = [root]
...
plot3 = plt.plot(range(3,21), t3.time_arr1)
plt.setp(plot1, color = 'r',linewidth = 2.0)
plt.setp(plot3, color = 'b', linewidth = 2.0)
#plt.show()

plt.subplot(212)
plot2 = plt.plot(range(3,21),time_arr2)
plot4 = plt.plot(range(3,21),t3.time_arr2)
plt.setp(plot2, color = 'r',linewidth = 2.0)
plt.setp(plot4, color = 'b',linewidth = 2.0)
plt.show()
